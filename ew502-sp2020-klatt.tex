...
\begin{figure}
%Angular Velocity (⍵) = Velocity / Radius (1)
%Angular Acceleration (α) = Δ⍵ / Δt (2)6
%Pitch Force
...
\label{tab:2}
%Performance Ratio Performance Score
%(⍵ / Avg ⍵, etc.) Justification
%< 0.9 0 Inadequate/Below-average Design
%.09 - 1.10 1 Average
%1.10-1.50 2 Above-average
%>1.50 3 Superior Design, >150% increase of normal UUV performance
\end{table}
